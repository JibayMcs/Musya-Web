...
$(document).ready(function() {
    ...
    $(window).on("load", function() {
        ...
        if (colorcode != "") {
            ...
            if (cssname != '') {
                var new_style = adminBaseUrl+'/public/assets/css/admin/css_picker/' + cssname + '.css'; //asset('assets/css'  + cssname + '.css'); //'assets/css/' + cssname + '.css'; 
    ...
    $('.colorchange').on("click", function() {
        ...
        var new_style = adminBaseUrl + '/public/assets/css/admin/css_picker/' + name + '.css'; //asset('assets/css'  + name + '.css'); //'assets/css/' + name + '.css';
        $('#theme-change').attr('href', new_style);
    });
