    ...
    @if(isset($settings['is_footer']) && $settings['is_footer'] == 1)
        <div class="ms_footer_wrapper">
            ...
            <div class="ms_footer_logo">
                <a class="getAjaxRecord" data-type="{{ $homepage }}" data-url="{{ url('/home') }}" href="javascript:void(0)"><img
                        src="{{ (isset($settings['mini_logo']) && $settings['mini_logo'] != '' ? asset('images/sites/'.$settings['mini_logo']) : asset('images/mini_logo.png')) }}" alt=""
                        class="img-fluid"/></a>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="footer_box footer_app">
                            ...
                            <a href="{{ isset($settings['google_play_url']) ? $settings['google_play_url'] : '#' }}" class="foo_app_btn"><img src="{{ asset('assets/images/google_play.jpg') }}" alt=""
                                                                                                                                              class="img-fluid"></a>
                            <a href="{{ isset($settings['app_store_url']) ? $settings['app_store_url'] : '#' }}" class="foo_app_btn"><img src="{{ asset('assets/images/app_store.jpg') }}" alt=""
                                                                                                                                          class="img-fluid"></a>
                        </div>
                    </div>
                    @php
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="footer_box footer_subscribe">
                            ...
                            <form id="newsLetter" method="post" action="{{ route('newsletter') }}" data-reset="1">
                                ...
                                <div class="form-group">
                                    <input type="text" name="email" class="form-control require" data-valid="email" data-error="Invalid email."
                                           placeholder="{{ __('adminWords.enter').' '.__('adminWords.email') }}">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="footer_box footer_contacts">
                            ...
                            <div class="foo_sharing">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ isset($settings['google_plus_url']) ? $settings['google_plus_url'] : ''  }}" target="_blank"><i class="fa fa-google-plus"
