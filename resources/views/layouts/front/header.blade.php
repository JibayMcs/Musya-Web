    ...
    <div class="ms_sidemenu_wrapper">
        ...
        <div class="ms_sidemenu_inner">
            ...
            <div class="ms_nav_wrapper">
                ...
                {{--<ul>
                    <li>
                        <a href="javascript:void(0)" class="{{ Request::path() == 'home' || Request::path() == 'home_2' ? 'active' : '' }} checkActive getAjaxRecord" data-type="{{ $homepage }}"
                           data-url="{{ url('/home') }}" title="{{ __('frontWords.home') }}">
        						<span class="nav_icon">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="{{ Nav::isRoute('user.artist') || Nav::isRoute('artist.single') ? 'active' : '' }} checkActive getAjaxRecord" data-type="artist"
                           data-url="{{ route('user.artist') }}" title="{{ __('adminWords.artist') }}">
                            <span class="nav_icon">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="{{ Nav::isRoute('user.album') ? 'active' : '' }} checkActive getAjaxRecord" data-type="album" data-url="{{ route('user.album') }}"
                           title="{{ __('adminWords.album') }}">
        						<span class="nav_icon">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="{{ Nav::isRoute('user.genres') || Nav::isRoute('genre.single') ? 'active' : '' }} checkActive getAjaxRecord" data-type="genre"
                           data-url="{{ route('user.genres') }}" title="{{ __('adminWords.genre') }}">
        						<span class="nav_icon">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="{{ Nav::isRoute('user.audio') || Nav::isRoute('audio.single') ? 'active' : '' }} checkActive getAjaxRecord" data-type="audio"
                           data-url="{{ route('user.audio') }}" title="{{ __('frontWords.top_track') }}">
        						<span class="nav_icon">
                ...
                {{--<ul class="nav_downloads">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="{{ Nav::isRoute('user.favourite') ? 'active' : '' }} checkActive getAjaxRecord" data-type="favourite"
                           data-url="{{ route('user.favourite') }}" title="{{ __('frontWords.favourites') }}">
        						<span class="nav_icon">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="{{ Nav::isRoute('user.history') ? 'active' : '' }} checkActive getAjaxRecord" data-type="history" data-url="{{ route('user.history') }}"
                           title="{{ __('frontWords.history') }}">
            					<span class="nav_icon">
                ...
                {{-- <ul class="nav_playlist">
                     <li>
                         <a title="{{__('frontWords.playlist') }}" class="{{ Nav::isRoute('user.playlist') ? 'active' : '' }} checkActive getAjaxRecord" data-type="playlist"
                            data-url="{{ route('user.playlist') }}" href="javascript:void(0)">
                                 <span class="nav_icon">
            ...
            <div class="ms_header_inner">
                <div class="ms_top_left">
                    <div class="ms_top_search">
                        <input type="text" class="form-control" id="search_value" placeholder="{{ __('frontWords.search').' '.__('frontWords.music').' '.__('frontWords.here') }}"
                               value="@yield('search')">
                    ...
                    {{--@if(isset(Auth::user()->id))
                        <div class="ms_noti_wrap">
                            @php $users = \App\Models\User::find(Auth::user()->id);
                                ...
                                @if($notification_count > 0)
                                    ...
                                    <ul class="close_options">
                                        @foreach($users->notifications as $notification)
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        <span class="notification_icon">
                                                            @if($notification->read_at != '')
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="read_at" x="0px" y="0px"
                                                                     viewBox="0 0 308.728 308.728" xml:space="preserve"><path
                                                                        d="M153.188,27.208c-37.562,1.134-130,55.057-144.495,63.65l-7.981,32.664l40.236,28.809l-7.733-27.01l189.62-54.288    l26.895,93.949l58.098-41.331l-10.004-32.698C283.848,82.656,190.877,28.342,153.188,27.208z"></path><polygon
                                                                        points="308.728,281.52 308.728,195.199 308.728,160.289 308.728,136.255 306.809,137.621 252.882,175.988     222.101,197.888 226.557,202.27 231.942,207.581 237.326,212.886 243.833,219.288 307.02,281.52   "></polygon><polygon
                                                                        points="0,137.415 0,150.224 0,281.52 1.479,281.52 60.832,221.766 66.667,215.892 72.127,210.391 77.588,204.891     85.158,197.271 45.731,169.042 8.147,142.135 0,136.299   "></polygon><path
                                                                        d="M231.905,222.705l-9.692-9.545l-5.39-5.311l-5.39-5.31l-1.382-1.366l-5.489-5.4l-0.954-0.938    c-1.599-1.576-3.27-3.053-4.989-4.461c-12.777-10.457-28.655-16.158-45.399-16.158c-16.767,0-32.616,5.69-45.394,16.137    c-1.938,1.582-3.813,3.265-5.598,5.058l-0.334,0.338l-5.363,5.399l-3.452,3.48l-5.458,5.495l-5.46,5.495l-17.921,18.046    l-47.276,47.593h274.396L231.905,222.705z"></path></svg>
                                                            @else
                                                                <svg id="unread_msg" xmlns="http://www.w3.org/2000/svg" viewBox="0 -92 512 512"><path
                                                                        d="m512 307.996094v-285.585938l-170.816406 141.289063zm0 0"/><path
                                                                        d="m265.714844 226.125c-2.820313 2.328125-6.265625 3.496094-9.714844 3.496094s-6.894531-1.167969-9.714844-3.496094l-51.605468-42.683594-170.128907 143.714844h462.898438l-170.132813-143.714844zm0 0"/><path
                                                                        d="m491.273438 0h-470.546876l235.273438 194.601562zm0 0"/><path d="m0 22.410156v285.585938l170.816406-144.296875zm0 0"/></svg>
                                                            @endif
                                                        </span>
                                                        <div class="notification_info">
                                                            ...
                                                            <small><i class="fa fa-clock-o"
                                                                      aria-hidden="true"></i>{{ Illuminate\Support\Carbon::parse($notification->created_at)->diffForHumans(Illuminate\Support\Carbon::now()) }}
                                                            </small>
                                                        </div>
                                                        <div class="notification-status">
                                                            <span class="notification-option-btn">
                                                                <svg xmlns:xlink="http://www.w3.org/1999/xlink" width="4px" height="20px"><path fill-rule="evenodd" fill="rgb(124, 142, 165)"
                                            ...
                                            @else
                                                <div class="drop-down-footer no_new_notification">
                                                    <p style="margin-top: 65px;">
                                                        <b style="color:red;">{{ __('frontWords.no_notification') }}</b>
                                                    </p>
                                                </div>
                                            @endif
                                        @endforeach
                ...
                <div class="ms_top_right">
                    ...
                    <div class="ms_pro_inner">
                        @if(isset(Auth::user()->id))
                            @php $users = \App\Models\User::find(Auth::user()->id); @endphp
                            <div class="ms_top_btn userloggedIn">
                                ...
                                <ul class="ms_common_dropdown ms_profile_dropdown pro_dropdown_menu">
                                    ...
                                    <li><a class="getAjaxRecord" data-type="playlist" data-url="#" href="javascript:void(0)"><span
                                                class="common_drop_icon drop_pro playlist_icon"></span>
                                            {{ __('frontWords.my').' '.__('frontWords.playlist') }}</a>
                                    </li>
                                    <li class=""><a class="getAjaxRecord" data-url="{{ url('blogs') }}" href="javascript:void(0)"><span
                                                class="common_drop_icon drop_pro blog_icon"></span>
                                            {{ __('adminWords.blogs') }}</a>
                                    </li>
                                    <li><a href="{{route('logout') }}"><span class="common_drop_icon drop_logt"></span>
