        ...
        {{--<ul class="main-menu">
                ...
                <a href="{{url('/admin')}}" class="{{ Nav::isRoute('admin') ? 'active' : ''}}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                     class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                            </span>
            ...
            <li>
                <a href="{{url('/users')}}" class="{{ Nav::isRoute('users') || Nav::isRoute('create') || Nav::isRoute('editUser') ? 'active' : '' }}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                     class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path
                ...
                <a href="javascript:void(0);" class="{{ Nav::isRoute('artist') || Nav::isRoute('artist.create') || Nav::isRoute('artist.edit') ? 'active' : '' }}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-user-plus"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line
            ...
            <li>
                <a href="javascript:void(0);" class="{{ Nav::isRoute('audio') || Nav::isRoute('audio.create') || Nav::isRoute('audio.edit') ? 'active' : '' }}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-music"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16"
                                                                                                                                                                          r="3"></circle></svg>
            ...
            <li>
                <a href="{{url('/admin/playlist')}}" class="{{ Nav::isRoute('admin.playlist') || Nav::isRoute('admin.playlist.create') || Nav::isRoute('admin.playlist.edit') ? 'active' : ''}}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-list"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18"
                                                                                                                                                                                      x2="21"
                                                                                                                                                                                      y2="18"></line><line
                                        x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>
                            </span>
                    <span class="menu-text">
            ...
            <li>
                <a href="{{url('/album')}}" class="{{ Nav::isRoute('album.create') || Nav::isRoute('album.edit') ? 'active' : ''}}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-film"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"></rect><line x1="7" y1="2" x2="7" y2="22"></line><line
                                        x1="17" y1="2" x2="17" y2="22"></line><line x1="2" y1="12" x2="22" y2="12"></line><line x1="2" y1="7" x2="7" y2="7"></line><line x1="2" y1="17" x2="7"
                                                                                                                                                                         y2="17"></line><line x1="17"
                                                                                                                                                                                              y1="17"
                                                                                                                                                                                              x2="22"
                                                                                                                                                                                              y2="17"></line><line
            ...
            <li>
                <a href="{{url('/subscription')}}" class="{{ Nav::isRoute('subscription') || Nav::isRoute('user.invoice') ? 'active' : ''}}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-hard-drive"><line x1="22" y1="12" x2="2" y2="12"></line><path
                                        d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path><line x1="6" y1="16" x2="6.01"
                                                                                                                                                                    y2="16"></line><line x1="10" y1="16"
                                                                                                                                                                                         x2="10.01"
                                                                                                                                                                                         y2="16"></line></svg>
                            </span>
                    <span class="menu-text">
            ...
            <li>
                <a href="{{url('/coupon_management')}}" class="{{ Nav::isRoute('coupon_management') || Nav::isRoute('coupon.create') || Nav::isRoute('coupon.edit') ? 'active' : ''}}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-percent"><line x1="19" y1="5" x2="5" y2="19"></line><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5"
                                                                                                                                                                                           cy="17.5"
                                                                                                                                                                                           r="2.5"></circle></svg>
                            </span>
                    <span class="menu-text">
            ...
            <li>
                <a href="{{url('/advertisement')}}" class="{{ Nav::isRoute('adv') ||  Nav::isRoute('adv.create') ||  Nav::isRoute('adv.edit') ? 'active' : ''}}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-sunrise"><path d="M17 18a5 5 0 0 0-10 0"></path><line x1="12" y1="2" x2="12" y2="9"></line><line x1="4.22"
                                                                                                                                                                                     y1="10.22"
                                                                                                                                                                                     x2="5.64"
                                                                                                                                                                                     y2="11.64"></line><line
                                        x1="1" y1="18" x2="3" y2="18"></line><line x1="21" y1="18" x2="23" y2="18"></line><line x1="18.36" y1="11.64" x2="19.78" y2="10.22"></line><line x1="23" y1="22"
                                                                                                                                                                                         x2="1"
                                                                                                                                                                                         y2="22"></line><polyline
                                        points="8 6 12 2 16 6"></polyline></svg>
                            </span>
                    <span class="menu-text">
                                {{ __('adminWords.adv') }}
                            </span>
            ...
            <li>
                <a href="javascript:void(0);"
                   class="{{ Nav::isRoute('blog') || Nav::isRoute('create_blog') || Nav::isRoute('editBlog') || Nav::isRoute('blog_category') || Nav::isRoute('comments') ? 'active' : '' }}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path
            ...
            <li>
                <a href="javascript:void(0);" class="{{ Nav::isRoute('country') || Nav::isRoute('state') || Nav::isRoute('city') ? 'active' : '' }}">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-map-pin"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10"
                                                                                                                                                                     r="3"></circle></svg>
                            </span>
                    <span class="menu-text">
            ...
            <li>
                ...
                <ul class="sub-menu {{ Nav::isRoute('artist.genre') || Nav::isRoute('artist') || Nav::isRoute('artist.create') || Nav::isRoute('artist.edit') ? 'menu-show' : '' }}">
                    ...
                    <li>
                        <a class="{{ Nav::isRoute('tax') ? 'active' : ''}}" href="{{url('/tax')}}">
                            <span class="icon-dash"></span>
                            <span class="menu-text">
                                        {{ __('adminWords.tax') }}
                                    </span>
